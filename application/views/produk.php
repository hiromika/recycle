          ...
          <div class="card mt-4">
            <div class="row">
                ...
                <div class="col-md-6 text-center" style="margin-top: 50px; padding-right: 30px;">
                  <h3 class="card-title" style="color: #007bff; text-transform: uppercase;"><?php echo $produk['produk_name']; ?></h3>
          ...
          <div class="col-md-6">
            ...
            <table>
              <h6>Detail Produk</h6>
                ...
                <tr>
                  <td colspan="2" style="color: #007bff; text-transform: uppercase;"><?php echo $produk['produk_name']; ?></td>
                </tr>
                <tr>
                  <!-- <th>Jumlah Barang</th> -->
                  <th>Harga Barang</th>
