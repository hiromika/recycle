<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('admin/users/history/').$detail->id_users;?>">History Top Up</a></li>
        ...
        <form class="form-horizontal">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" value="<?php echo $detail->username?>" class="form-control" placeholder="..." disabled>
              </div>
            </div>
          </div>
          <div class="box-body">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <img src="<?php echo base_url('bukti_users/').$detail->id_topup_user.$detail->extensi?>" width="256">
              </div>
            </div>
          </div>
        </form>
