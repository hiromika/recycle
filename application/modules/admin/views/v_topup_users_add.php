<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url('admin/topup/add_users'); ?>" method="POST" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Users</label>
              <div class="col-sm-10">
                <select class="form-control select2" name="id_users" required>
                  <option value="">-</option>
                  <?php
                    foreach($users as $d){
                  ?>
                  <option value="<?php echo $d->id_users?>"><?php echo $d->username.' | '.$d->nama?></option>
                  <?php   
                    }
                  ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <select name="jumlah" class="form-control">
                  ...
                  <option value="80000">Rp80.000</option>
