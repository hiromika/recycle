        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo base_url('admin/mahasiswa');?>" class="btn btn-info btn-sm pull-right">Kembali</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-responsive">
                <caption>Info Mahasiswa</caption>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      ?>
                      <td>
                        <a href="<?php echo base_url('admin/mahasiswa/detail_history/').$d->id_topup?>" title="detail" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
                        <a href="#" title="edit" class="btn btn-xs btn-success edit"><i class="fa fa-edit"></i></a>
                        <a href="<?php echo base_url('admin/topup/doDelete/').$d->id_topup.'/'.$id_users.'/2'?>" onclick="return confirm('Hapus saldo in ?')" title="detail" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                      $i++;
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                  ...
                  <input type="text" class="form-control" disabled name="nim" value="<?php echo $mhs['nim']; ?>" placeholder="">
                  <input type="hidden" name="sts" value="2" placeholder="">
              </div>
            </div>
          </div>
          <div class="box-body">
