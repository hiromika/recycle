<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url('admin/produk/add'); ?>" method="POST" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control select2" name="nim">
                  ...
                  ?>
                  <option value="<?php echo $d->id_users?>"><?php echo $d->nama?></option>
                  <?php   
                    }
                  ?>
                </select>
