  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!--   <li class="<?php if($title == 'Topup'){echo 'active';}?> treeview">
          ...
          <ul class="treeview-menu">
            <li <?php if($side == 'history' && $title == 'Topup'){echo 'class="active"';}?>><a href="<?php echo base_url('user/topup/history');?>"><i class="fa fa-circle-o"></i> History</a></li>
            <li <?php if($side == 'tambah'  && $title == 'Topup'){echo 'class="active"';}?>>
              <a href="<?php echo base_url('user/topup/tambah');?>">
