<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('mahasiswa/profile');?>"><i class="fa fa-user"></i> User</a></li>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <hr>
        <form action="<?php echo base_url('mahasiswa/uploadBukti') ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
