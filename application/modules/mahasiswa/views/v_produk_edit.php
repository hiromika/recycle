<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url('mahasiswa/produk/update'); ?>" method="POST" enctype="multipart/form-data">
          <div class="box-body">
                ...
                <select class="form-control select2" name="kategori">
                  <?php
                    foreach ($kategori as $key => $value) { ?>
                      <option value="<?php echo $value['id_kategori']?>" <?php if($produk['id_kategori'] == $value['id_kategori']){echo 'selected';}?>><?php echo $value['nama']?></option>
                  <?php   
                    }
                  ?>
                </select>
